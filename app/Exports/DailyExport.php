...
class DailyExport extends DefaultValueBinder implements FromArray, WithTitle, ShouldAutoSize, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    protected $data;
    protected $title = 'Daily Export';
