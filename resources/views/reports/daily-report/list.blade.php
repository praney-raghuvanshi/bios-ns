...
@section('page-script')
<script src="{{asset('assets/js/daily-report/report.js')}}"></script>
@endsection

@section('content')
<h4 class="mb-4">
    <span class="text-muted fw-light">BIOS /</span> Daily Report
</h4>
...
<div class="card">
    ...
    <div class="card-body">
        <form id="dailyReportForm" method="POST" action="{{ route('reports.daily-report.list') }}">
            @csrf
            ...
            <div class="row mt-3">
                <div class="col text-center">
                    <button type="submit" class="btn btn-primary" id="dailyReportRunBtn">Run Report</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="card mt-2">
    <div class="card-header text-center">
        <form action="{{ route('reports.daily-report.export') }}" method="POST">
            @csrf
