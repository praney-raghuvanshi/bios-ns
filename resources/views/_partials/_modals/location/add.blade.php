    ...
    <div class="modal-dialog modal-lg modal-simple">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="addLocationForm" class="row g-3" method="POST"
                    action="{{ route('maintenance.location.store') }}">
                    @csrf
                    <div class="col-12 col-md-6">
                        ...
                        <select name="zone" class="select2 form-select" data-allow-clear="true">
                            ...
                            <option value="{{$zone->id}}" @if(old('zone')===$zone->id) selected @endif>{{ $zone->name }}
                            </option>
                            @endforeach
                        </select>
                    </div>
